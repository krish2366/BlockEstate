...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={onHandleSubmit} class="max-w-96 w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
      ...
      <button
        type="submit"
        class="mt-2 w-full h-11 rounded-full text-white bg-indigo-500 hover:opacity-90 transition-opacity"
      >
        Login
      </button>
      <p class="text-gray-500 text-sm mt-3 mb-11">
